      ...
      <div className="navbar-container">
        <nav className={notification || search ? "active-nav" : ""}>
          ...
          <span className="search-icon" onClick={() => searchBar()}>
            <span
              className={
                search ? "search-icon-active search-icon-btn-hover" : "search-icon-btn-hover"
              }>
              <svg
                aria-label="Search"
                className="_ab6-"
          ...
          <span className="notification" onClick={() => notificationBar()}>
            <span
              className={
                notification
                  ? "notification-active notification-btn-hover"
          ...
          <span className="post" onClick={() => createpost()}>
            <span
              className={
                activeTab === "Post" ? "create-post-active post-btn-hover" : "post-btn-hover"
              }>
              <svg
                aria-label="New post"
                className="_ab6-"
          ...
          <Link href="/profile">
            <div className={activeTab === "Profile" ? "profile profile-active" : "profile"}>
              <span className="dp profile-btn-hover">
                <img
                  className={activeTab === "Profile" ? "dp-img dp-active" : "dp-img"}
        ...
        <Link href="/explore">
          <span className="search-icon">
            <span
              className={
                activeTab === "Explore"
                  ? "search-icon-active search-icon-btn-hover"
