     ...
     <div className="post-head">
         <div className="post-info">
            <span className="timeline-story" style={{position: "relative"}}>
                <img loading="lazy" className="profile-pic" src="/ronaldo.jpg" />
             </span>  

        <div className="info-text">
          <p className="account-name">cristiano</p>             
        </div> 
        ...
        <span className="more-option" onClick={() => setMenu(true)}>
            <svg aria-label="More options" className="_ab6-" color="#262626" fill="#262626" height="24" role="img" viewBox="0 0 24 24" width="24"><circle cx="12" cy="12" r="1.5"></circle><circle cx="6" cy="12" r="1.5"></circle><circle cx="18" cy="12" r="1.5"></circle></svg>
        </span>
       ...
       <div className="reaction">
        ...
        <span className="save-btn" onClick={() => setSaved(!saved)}>
            <svg aria-label="Save" className="_ab6-" color="#262626" fill="#262626" height="24" role="img" viewBox="0 0 24 24" width="24"><polygon fill={ saved ? "000" : "none"} points="20 21 12 13.44 4 21 4 3 20 3 20 21" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></polygon></svg>
        </span>
       </div>
       ...
       <div className="post-stats">
        ...
        <a className="comment-count" href="#">View all 42,958 comments</a>
       ...
       <div className="comment">
        ...
        <form className="comment-input" action="#" method="get">
            <textarea className="input-comment" name="comment" id="comment" placeholder="Add a comment..."></textarea>
