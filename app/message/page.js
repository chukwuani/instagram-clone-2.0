...
const [post, setPost] = useState(false)
  ...
  return (
    <main>
      <Navbar active="Message" top={false} post={setPost} setter={post}/>
                ...
                <div className="switch-chat-acct-head">
                   <div className="switch-chat-acct">
                     ...
                     <span className="down-switch-chevron">
                        <svg aria-label="Down chevron icon" className="_ab6-" color="#262626" fill="#262626" height="20" role="img" viewBox="0 0 24 24" width="20"><path d="M21 17.502a.997.997 0 0 1-.707-.293L12 8.913l-8.293 8.296a1 1 0 1 1-1.414-1.414l9-9.004a1.03 1.03 0 0 1 1.414 0l9 9.004A1 1 0 0 1 21 17.502Z"></path></svg>
                     </span>
                   </div>
                ...
                <div className="active-chat">
                    <ul className="active-chat-list">
                         ...
                         <li className="active-list">
                            ...
                            <img className="chat-profile" src="https://api.dicebear.com/5.x/avataaars-neutral/svg?seed=Bubba" alt="avatar" />       
                            </span>  
                            <a className="chat" href="#"><div>
