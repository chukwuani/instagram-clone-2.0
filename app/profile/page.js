    ...
    <div className="homepage profile-color">
        ...
        <div className="user-profile-head-container">
          <span className="user-profile-picture">
            <img src="https://api.dicebear.com/5.x/avataaars-neutral/svg?seed=Muffin" alt="user-profile-picture" />
          </span>
          ...
          <div className="user-profile-stats">
            ...
            <div className="profile-stats-1">
                <h1>the_wylde</h1>
                <a className="edit-profile" href="https://Instagram.com/accounts/edit">Edit profile</a>
            ...
            <div class="profile-stats-2">
                <p><a class="number-post" href="#">0</a> posts</p>
                <p><a href="#">321</a> followers</p>
                <p><a href="#">538</a> following</p>
            </div>

            <div class="profile-stats-3">
              <p className="name">Allen Brown</p>
              <span className="bio">
              <p>Yup, I'm just another Instagram influencer</p> 
              <p>Welcome to my 👑dom</p> 
              <p>🐦: <a className='bio-link' href="https://twitter.com/_stevecodes">https://twitter.com/_stevecodes</a></p> 
              </span>
            </div>
        ...
        <div className="mobile-stats-two">
          <p><a className="number-post" href="#">0</a> posts</p>
          <p><a href="#">321</a> followers</p>
          <p><a href="#">538</a> following</p>  
        </div>
        ...
        <div className="user-profile-bottom-section-container">
            <div className="user-profile-bottom-cta">
                <ul className="user-profile-bottom-cta-list-item">
                    <li className={activeCta === "Share" ? "active-bottom-cta user-cta": "user-cta"} onClick={() => setActivecta("Share")}>
                        <span>
                    ...
                    <li className={activeCta === "Saved" ? "active-bottom-cta user-cta": "user-cta"} onClick={() => setActivecta("Saved")}>
                        <span>
                    ...
                    <li className={activeCta === "Tagged" ? "active-bottom-cta user-cta" : "user-cta"} onClick={() => setActivecta("Tagged")}>
                        <span>
