...
export default function Navbar({ active, top }) {
  // Show dropdown arroe on scroll
    ...
    <>
      ...
      <div className="navbar-container">
        <nav className={notification || search ? "active-nav" : ""}>
          <Link href="/" className="logo-conatiner">
          ...
          <div className="create-post-wrapper">
            ...
            {/* <ul className="create-post-dropdown">
              <li className="create-post-dropdown-li">
                <svg
                  aria-label="Settings"
                  className="_ab6-"
                  color="#262626"
          ...
          <div className="nav-more-container">
            <div
              className={showmore ? "nav-more nav-more-active" : "nav-more"}
